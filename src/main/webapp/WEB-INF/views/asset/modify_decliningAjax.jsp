	...
	<thead class="thead">
		...
		<td colspan="2" style="margin-right: 16px;">내용연수/상각률(원수) <span class="asteriskField">*</span></td>
			<td><input type="text" id="serviceLife" style="width: 50px;" value="${asset.serviceLife }" >
				<input type="button"  class="btn btn-secondary btn-sm" data-toggle="modal" class="serviceBtn" data-target="#my80sizeModal5" value="▦">
		...
		<div class="modal-content modal-lg">
			<div class="modal-header" style="background:#6C757D; height: 50px">
				...
				<div class="modal-body" align="center">
				  ...
				  <button type="button" class="buttons" class="btn btn-primary" data-dismiss="modal">닫기</button>
				  <input type="hidden" class="buttons" data-dismiss="modal" value=""/>
				</div>
			</div>
	</div>
