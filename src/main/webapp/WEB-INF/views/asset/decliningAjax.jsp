...
<table class="table table-sm">
	<thead class="thead">
		...
		<tr>
			...
			<td><input type="text" id="sanggakCode" name="sanggakCode">
		...
		<td colspan="2"  style="margin-right: 16px;">내용연수/상각률(원수) <span class="asteriskField">*</span></td>
			<td><input type="text" id="serviceLife" style="width: 50px;">
				<input type="button" class="btn btn-secondary btn-sm"  data-toggle="modal" data-target="#my80sizeModal5" value="▦">
			<input type="text" id="depreciationRate" name="depreciationRate" style="width: 65px;" >
				(&nbsp;<input type="text" id="month" style="width: 50px;">&nbsp;)
				<input onclick="myClick();"class="btn btn-secondary btn-sm"  type="button" data-toggle="modal" data-target="#my80sizeModal6" value="년수별상각율">
			</td>
		</tr>
		<tr>
			<td colspan="2"  style="margin-right: 16px;">감가상각누계액<span class="asteriskField">*</span></td>
			<td colspan="2" ><input type="text" id="accumulated" name="accumulated"></td> 
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="2"><input type="text" id="residualvalue" name="residualvalue" value="0"></td> 
		</tr>
		<tr>
