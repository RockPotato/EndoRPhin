...
<body>
 <button id="dapjangBtn" style="display: none;">Open Modal</button>
 <form id="messagesendForm" onsubmit="return false;">
	<div id="messageModal" class="modal message" style="cursor: move; z-index: 2000">
		<div class="modal-content message-content" style="padding: 20px">
				...
				<div style="float: left; text-align:left; width: 70%;">아이디 : <span id="user"></span>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				이름 : <span id="name"></span>
				
				</div>
				</div>
				<textarea id="textMessage" style="margin-top: 10px;height: 200px" class="form-control" rows="5" placeholder="내용을 입력하세요"
				name="content"></textarea>
				
				<div id="send2" class="row" style="margin-top: 20px">
				<div style=" float: left; text-align:right; width: 80%;">
				<button id="sendMessageBtn" type="button" style="background-color: #6E6867;"
				class="btn btn-info" >전송</button>
				</div>
				<div style="float: left; width: 20%;">
				<button id="closebtn1" style="background-color: #6E6867;"
