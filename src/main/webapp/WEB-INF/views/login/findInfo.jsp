    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-center h-100">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-signin" action="/findIdSave" method="post">
                        <div class="input-group form-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-user"></i></span>
                            </div>
                            <input name="userNm" id="userNm" type="text" class="form-control" placeholder="회원이름" required autofocus>
                        ...
                        <div class="input-group form-group">
                            ...
                            <input name="BirthDate" id="BirthDate" type="text" class="form-control" placeholder="생년월일 yy/mm/dd">
                        </div>
                        <div class="row align-items-center remember">
                        </div>
                        <div class="form-group">
                            <button data-transition="pop" class="btn btn-lg btn-primary btn-block" type="button" id="findId">Find Id</button>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#BirthDate").keydown(function(key) {
            if (key.keyCode == 13)
                findInfo();
        });
